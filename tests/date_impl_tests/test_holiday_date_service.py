...
@patch("ttrpg_bot.date_impl.holiday_date_service.holidays.country_holidays")
...
@patch("ttrpg_bot.date_impl.holiday_date_service.holidays.country_holidays", return_value=UK_BANK_HOLS_2023)
