...
from ttrpg_base.application.dates_impl.holidays_date_service import HolidaysHolidayDateService
...
@patch("ttrpg_base.application.dates_impl.holidays_date_service.holidays.country_holidays")
...
@patch("ttrpg_base.application.dates_impl.holidays_date_service.holidays.country_holidays", return_value=UK_BANK_HOLS_2023)
