...
from ttrpg_bot.dates_impl.holidays_date_service import HolidaysHolidayDateService
...
@patch("ttrpg_bot.dates_impl.holidays_date_service.holidays.country_holidays")
...
@patch("ttrpg_bot.dates_impl.holidays_date_service.holidays.country_holidays", return_value=UK_BANK_HOLS_2023)
